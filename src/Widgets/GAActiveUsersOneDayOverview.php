...
class GAActiveUsersOneDayOverview extends StatsOverviewWidget
{
    ...
    {
        return [
            GAStatsBuilder::make(__('filament-google-analytics::widgets.one_day_active_users'))
                ->usingResponse(GAResponse::activeUsers(GADataLookups::activeUsers(), $this->filter))
